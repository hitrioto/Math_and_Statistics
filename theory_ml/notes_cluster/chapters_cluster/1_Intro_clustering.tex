...
\subsection{Уводни бележки}
	...
	\noindent
	Първата книга покрива материала самообучение с учител(supervised machine learning), от втората книга ще вземем втората част от курса - самообучение без учител. \\
	Какво ще съдържа курса?  логистична регресия.
	Модели с дървета - Decision trees, Random forest, приложения. Support Vector Machines. Клъстериране. Expectation-Maximization algorithms   \\
